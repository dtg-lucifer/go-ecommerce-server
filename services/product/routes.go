...
type Handler struct {
	store     typedef.ProductStore
	userStore typedef.UserStore
}

func NewHandler(store typedef.ProductStore, userStore typedef.UserStore) *Handler {
...
func (h *Handler) handleCreateProduct(w http.ResponseWriter, r *http.Request) {
	var product typedef.CreateProductPayload
